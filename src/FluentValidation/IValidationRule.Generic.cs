...
namespace FluentValidation {
	...
	public interface IValidationRule<T, TProperty> {
		...
		/// </summary>
		IEnumerable<IPropertyValidator<T,TProperty>> Validators { get; }
		/// <summary>
		...
		void ApplyCondition(Func<PropertyValidatorContext<T,TProperty>, bool> predicate, ApplyConditionTo applyConditionTo = ApplyConditionTo.AllValidators);
		...
		/// <param name="predicate">The condition to apply</param>
		/// <param name="applyConditionTo">Indicates whether the condition should be applied to all validators in the rule, or only the current one</param>
		void ApplyAsyncCondition(Func<PropertyValidatorContext<T,TProperty>, CancellationToken, Task<bool>> predicate, ApplyConditionTo applyConditionTo = ApplyConditionTo.AllValidators);
