...
namespace FluentValidation.Validators {
	...
	public abstract class EmailValidatorBase<T> : PropertyValidator<T,string>, IEmailValidator {
	...
	[Obsolete("Regex-based email validation is not recommended and is no longer supported.")]
	public class EmailValidator<T> : EmailValidatorBase<T>, IRegularExpressionValidator, IEmailValidator {
	...
	public class AspNetCoreCompatibleEmailValidator<T> : EmailValidatorBase<T>, IEmailValidator {
