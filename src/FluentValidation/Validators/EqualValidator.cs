...
namespace FluentValidation.Validators {
	...
	public class EqualValidator<T,TProperty> : PropertyValidator<T,TProperty>, IComparisonValidator, IEqualValidator where TProperty : IComparable {
		...
		private object GetComparisonValue(PropertyValidatorContext<T,TProperty> context) {
			if (_func != null) {
