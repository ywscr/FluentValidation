...
namespace FluentValidation.Resources {
	...
	internal class SpanishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}' debe estar entre {From} y {To} (exclusivo). Actualmente tiene {Value}.",
			"InclusiveBetweenValidator" => "'{PropertyName}' debe estar entre {From} y {To}. Actualmente tiene {Value}.",
