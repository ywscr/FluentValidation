...
namespace FluentValidation.Resources {
	...
	internal class SlovenianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"MinimumLengthValidator" => "'{PropertyName}' mora imeti dolžino večjo ali enako {MinLength}. Vnesli ste {TotalLength} znakova.",
			"MaximumLengthValidator" => "'{PropertyName}' mora imeti dolžino manjšo ali enako {MaxLength}. Vnesli ste {TotalLength} znakova.",
